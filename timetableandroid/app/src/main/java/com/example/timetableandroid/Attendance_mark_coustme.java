...
public class Attendance_mark_coustme extends ArrayAdapter<String>  {

    private Activity context;       //for to get current activity context
    SharedPreferences sh;
    private String[] student_name, course_name, department_name,photo;


    public Attendance_mark_coustme(Activity context, String[] student_name, String[] course_name, String[] department_name, String[]dob, String[] gender, String[] place, String[] post, String[] pincode, String[] district, String[] phone, String[] photo) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_attendance_mark_coustme, photo);
...
//        this.phone = phone;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_attendance_mark_coustme, null, true);
...
//	       Toast.makeText(context, pth, Toast.LENGTH_LONG).show();
        ...
        Picasso.with(context)
                ...
                .error(R.drawable.ic_launcher_foreground).into(im);
//
        return  listViewItem;
    }
