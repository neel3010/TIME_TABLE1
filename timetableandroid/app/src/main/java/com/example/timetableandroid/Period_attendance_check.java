...
public class Period_attendance_check extends AppCompatActivity implements JsonResponse, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_period_attendance_check);
...
//        });
        ...
        JR.json_response = (JsonResponse) Period_attendance_check.this;
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                JsonReq JR = new JsonReq();
                JR.json_response = Period_attendance_check.this;
