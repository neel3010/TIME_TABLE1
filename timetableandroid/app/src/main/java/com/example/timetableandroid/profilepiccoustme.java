...
public class profilepiccoustme extends ArrayAdapter<String>  {
    ...
    public profilepiccoustme(Activity context,String[] student_name, String[] course_name, String[] department_name,String[]dob, String[] gender, String[] place, String[] post, String[] pincode, String[] district, String[] phone, String[] photo) {
        //constructor of this class to get the values from main_activity_class

        super(context, R.layout.activity_profilepiccoustme, photo);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.activity_profilepiccoustme, null, true);
...
//        TextView t5=(TextView)listViewItem.findViewById(R.id.textView5);
        ...
        String text = "Course : " + course_name[position]
